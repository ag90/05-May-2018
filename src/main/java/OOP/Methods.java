...
public class Methods extends Variables  {
  ...
  /* public void K3(){
	...
	public void Thiskeyword(int y, String str){//use this keyword if instance and local variables having same name and to call for only current class variables.
